...
public class BaseTestECKeyImport extends BaseTestJunit5 {
    ...
    public void testCreateKeyPairImportCompareEncodings() throws Exception {
        ...
        KeySpec privateKeySpec2 = keyFactory.getKeySpec(privateKey, ECPrivateKeySpec.class);
        PrivateKey importPrivateKey2 = keyFactory.generatePrivate(privateKeySpec2);
        ...
        byte[] importPrivKeyBytes2 = importPrivateKey2.getEncoded();

        System.out.println("Original key: " + bytesToHex(originalPrivKeyBytes));
        System.out.println("Imported key: " + bytesToHex(importPrivKeyBytes2));
