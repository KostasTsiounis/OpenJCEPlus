...
public final class RSAKey implements AsymmetricKey {
    ...
    private RSAKey(NativeInterface nativeInterface, long rsaKeyId, byte[] privateKeyBytes,
        ...
        this.provider.registerCleanable(this, cleanOCKResources(privateKeyBytes, rsaKeyId, pkeyId, nativeInterface));
    }
    ...
    private synchronized void obtainPKeyId() throws OCKException {
        ...
        if (pkeyId.getValue() == 0) {
            ...
            this.pkeyId.setValue(this.nativeInterface.RSAKEY_createPKey(rsaKeyId));
        }
    }
    ...
    private Runnable cleanOCKResources(byte[] privateKeyBytes, long rsaKeyId, PrimitiveWrapper.Long pkeyId, NativeInterface nativeInterface) {
        return () -> {
            try {
