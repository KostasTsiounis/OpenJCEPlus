...
class CurveDB {
    ...
    protected static Collection<? extends NamedCurve> getSupportedCurves() {
    ...
    private static void add(String name, String soid, int type, String sfield, String a, String b,
            String x, String y, String n, int h, Pattern nameSplitPattern) {
    ...
    static {
        ...
        add("secp192r1 [NIST P-192, X9.62 prime192v1]", "1.2.840.10045.3.1.1", PD,
                ...
                "FFFFFFFFFFFFFFFFFFFFFFFF99DEF836146BC9B1B4D22831", 1, nameSplitPattern);
        ...
        add("brainpoolP160r1", "1.3.36.3.3.2.8.1.1.1", P,
                ...
                "E95E4A5F737059DC60DF5991D45029409E60FC09", 1, nameSplitPattern);
        ...
        add("brainpoolP192r1", "1.3.36.3.3.2.8.1.1.3", P,
                ...
                "C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 1, nameSplitPattern);
        ...
        add("brainpoolP224r1", "1.3.36.3.3.2.8.1.1.5", P,
                ...
                "D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", 1, nameSplitPattern);
